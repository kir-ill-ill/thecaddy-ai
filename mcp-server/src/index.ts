  ...
  try {
    switch (name) {
      case 'extract_trip_brief': {
        const { user_message, chat_context = {}, now_date } = args as any;
...
Return a JSON object with:
{
  ...
  "notes": "..."
      ...
      case 'plan_trip_options': {
        const { trip_brief, inventory_context = {} } = args as any;
...
Return a JSON object with:
{
  ...
  "notes": "..."
      ...
      case 'negotiate_plan': {
        const { trip_brief, shortlist, group_responses } = args as any;
